  ...
  if (event.type === 'checkout.session.completed') {
    ...
    try {
      ...
      const { error: dbError } = await supabase
        .from('sessions')
        .insert({ code, email, sessions_total, sessions_used: 0 });
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
                  ...
                  <tr><td style="background:#1a1028;border:1px solid #3b1f6a;border-radius:16px;padding:40px;">
                    ...
                    <div style="text-align:center;margin-bottom:32px;">
                      <a href="https://www.plumlo.com/app.html?paid=true" style="display:inline-block;background:#7c3aed;color:#fff;font-weight:700;font-size:1rem;padding:16px 32px;border-radius:10px;text-decoration:none;">
